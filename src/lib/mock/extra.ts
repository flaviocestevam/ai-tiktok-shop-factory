...
export const casosDiagnostico: CasoDiagnostico[] = [
  ...
  { id: "c3", titulo: "Pouca view + boa conversão", diagnostico: "Produto vende, mas criativo não alcança gente suficiente.", acao: "Manter produto e criar novos ganchos, capas e formatos mais visuais.", status: "Corrigir gancho", exemploCriativo: "Organizador silencioso", views: 24000, cliques: 1900, vendas: 86 },
